...
--
-- Host: localhost
-- Generation Time: Jan 22, 2024 at 08:18 PM
...
CREATE TABLE `birth_info` (
  `birthID` mediumint(9) UNSIGNED NOT NULL,
  `user_birthID` int(255) NOT NULL,
...
INSERT INTO `birth_info` (`birthID`, `user_birthID`, `sex`, `month`, `day`, `year`, `hour`, `minute`, `timezone`, `timezone_txt`, `long_deg`, `long_min`, `ew`, `lat_deg`, `lat_min`, `ns`, `comments`, `entry_date`, `admin_response`, `respond_date`, `long_secs`, `lat_secs`) VALUES
(1, 0, 'm', '9', '7', '1978', '14', '30', '1', 'Europe/Madrid', '3', '42', '-1', '40', '25', '1', NULL, '2021-02-17', NULL, NULL, '13.6440', '0.3900'),
(2, 0, 'f', '5', '7', '1972', '06', '00', '1', 'Europe/Madrid', '1', '26', '1', '38', '55', '1', NULL, '2021-02-17', NULL, NULL, NULL, NULL),
(3, 0, 'f', '11', '29', '1979', '01', '00', '-3', 'America/Sao_Paulo', '46', '37', '-1', '23', '32', '-1', NULL, '2021-02-17', NULL, NULL, NULL, NULL);
...
CREATE TABLE `Users` (
  ...
  `name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_nopad_ci DEFAULT NULL,
  `surname` varchar(50) NOT NULL,
  `sex` varchar(10) NOT NULL,
  `profession` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_nopad_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `birth_info`
  MODIFY `birthID` mediumint(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
