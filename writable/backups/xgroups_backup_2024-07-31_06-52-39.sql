...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`neo`@`localhost`*/ /*!50003 TRIGGER before_insert_message
BEFORE INSERT ON UserChatMessages
FOR EACH ROW
BEGIN
    -- Generate the messageID by concatenating sender_id, receiver_id, and timestamp
    SET NEW.messageID = CONCAT(
        'MID_',      -- Optional prefix for identification
        LPAD(NEW.sender_id, 4, '0'),  -- Zero-padded sender_id to a width of 4
        '_', 
        LPAD(NEW.receiver_id, 4, '0'),  -- Zero-padded receiver_id to a width of 4
        '_',
        DATE_FORMAT(NEW.timestamp, '%Y%m%d%H%i%s')  -- Timestamp in YYYYMMDDHHMISS format
    );
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`neo`@`localhost`*/ /*!50003 TRIGGER `populate_userBirthInfo_userID` AFTER INSERT ON `Users` FOR EACH ROW BEGIN
    INSERT INTO UserBirthInfo (userID) VALUES (NEW.userID);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2024-07-31 13:52:39
