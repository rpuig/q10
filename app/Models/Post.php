...
class Post extends BaseModel
{
	...
	protected $allowedFields    = ['title', 'subtitle','slug', 'post_image', 'post_icon', 'body', 'seo_title', 'seo_description', 'tags', 'seo_schema','on_homepage', 'parent'];
	...
	public function deleteWithCategories($id)
    {
		...
		$db = \Config\Database::connect();
		 ...
		 // Set the parent of the child posts to NULL
		 $db->table('posts')->update(['parent' => NULL], ['parent' => $id]);

		 // Delete related rows in post_categories
		 $db->table('post_categories')->delete(['post_id' => $id]);
	 
		 // Delete the post
		 $db->table('posts')->delete(['id' => $id]);
    }
}
