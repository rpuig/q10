...
function destiny_number($nums_table,$string_name2="full name"){
...
function destiny_number_full($nums_table,$string_name="name",$string_surname="surname"){
...
/* Soul number*/
function soul_number($nums_table,$string_name2="full name"){ 
