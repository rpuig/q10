...
if (!defined('SE_NEPTUNE'))define('SE_NEPTUNE', 7 );
if (!defined('SE_PLUTO'))define('SE_PLUTO',8  );
if (!defined('SE_CHIRON'))define('SE_CHIRON', 9 );
if (!defined('SE_LILITH'))define('SE_LILITH', 10 );
if (!defined('SE_TNODE'))define('SE_TNODE',  11);
if (!defined('SE_POF'))define('SE_POF', 12 );//this must be last thing before angle stuff
if (!defined('SE_VERTEX'))define('SE_VERTEX', 13 );
if (!defined('LAST_PLANET'))define('LAST_PLANET',  14);
