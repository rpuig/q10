...
class Swephp extends BaseController{
    ...
    private function calculatePlanets() {
        ...
        // 🔁 ADD TRUE NODE
        $pls = swe_calc_ut($this->jul_ut, SE_TRUE_NODE, SEFLG_SPEED | SEFLG_ECLIPTIC);
          $pls = swe_deltat_ex($this->jul_ut, SE_TRUE_NODE, SEFLG_SPEED | SEFLG_ECLIPTIC);
        if ($pls['rc'] >= 0) {
            $this->planets[] = [
                'name' => 'True Node',
                'lng' => $pls[0],
            ...
            $this->planets[] = [
                ...
                'declination' => -$pls[1], // optional: inverse declination
